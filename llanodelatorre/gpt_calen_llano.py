...
product_information = pd.read_csv('llanodelatorre/spreadsheets/calentadores_llano.csv')
responses = []
...
"calentador de agua", "tinaco", "instalación de Simplo"
...
df.to_csv("llanodelatorre/spreadsheets/cal.csv", index=False)