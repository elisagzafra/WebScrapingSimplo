...
while i <106:
    with open("llanodelatorre/products/calentadores" + str(i) + ".txt", "r", encoding='utf-8') as file:
        text = file.read()
...
df.to_csv('llanodelatorre/spreadsheets/calentadores_llano.csv', index=False)
